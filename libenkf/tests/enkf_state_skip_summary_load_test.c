...
bool check_ecl_sum_loaded(const enkf_main_type * enkf_main)
{
  ...
  run_arg_type * run_arg1    = run_arg_alloc_ENSEMBLE_EXPERIMENT( "run_id", fs, 0 , 0 , "simulations/run0", "name");
  enkf_state_type * state2   = enkf_main_iget_state( enkf_main , 1 );
  run_arg_type * run_arg2    = run_arg_alloc_ENSEMBLE_EXPERIMENT( "run_id", fs, 0 , 0 , "simulations/run1", "name");
